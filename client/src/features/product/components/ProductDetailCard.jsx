...
const PorductDetailCard = ({
  ...
  return (
    <React.Fragment>
      <div className="text-gray-600 text-2xl ms-4">
        <Link to={"/products"} className="btn btn-link btn-lg">
          {" "}
          {"<"} Go Back
        </Link>
      </div>
        ...
        <div className="grid items-start grid-cols-1 lg:grid-cols-3">
          ...
          <div className="py-6 px-8 max-lg:max-w-2xl">
                  ...
                  sizes?.map((size, idx) => {
                    return (
                      <button
                        key={idx}
                        type="button"
                        className="w-10 h-10 cursor-pointer border hover:border-slate-800 border-slate-800 font-semibold text-slate-900 text-sm rounded-full flex items-center justify-center shrink-0"
                      >
                        {size}
                      </button>
                    );
            ...
            <div className="mt-8 space-y-4">
              <button
                type="button"
                className="w-full px-4 py-2.5 cursor-pointer border border-slate-800 bg-transparent hover:bg-green-300 text-slate-900 text-sm font-medium rounded-md"
              >
                Add to cart
              </button>
              <button
