...
const SecondaryNavbar = () => {
  ...
  return (
    <React.Fragment>
      <header className="bg-white dark:bg-gray-900 rounded-t-xl">
          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex-1 sm:flex sm:items-center sm:gap-12 justify-start lg:px-2">
              <Link to={"/"} className="block text-teal-600 dark:text-teal-300">
                ...
                <p className="text-lg">EveryDayLux</p>
              </Link>
            ...
            <div className="md:flex md:items-center md:gap-12">
              ...
              {isOpen && (
                <>
                  <div className="inline md:hidden absolute end-0 top-[60px] z-10 mt-0.5 w-56 rounded-md border border-gray-100 bg-white shadow-lg dark:border-gray-800 dark:bg-gray-900">
                    <div className="p-2">
                      <a
                        href="#"
